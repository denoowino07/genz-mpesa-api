...
app.get('/', (req, res) => {
    res.send(`
        ...
        <body class="font-sans antialiased min-h-screen flex flex-col justify-between">
            ...
            <!-- Navbar (Inabadilika kulingana na sehemu aliyopo mtumiaji) -->
            <header class="border-b border-gray-800 bg-[#161b22] p-4">
                <div class="container mx-auto flex justify-between items-center">
                    <h1 class="text-2xl font-bold neon-text tracking-wider cursor-pointer" onclick="location.reload()">GENZTRENDING</h1>
            ...
            <main class="container mx-auto p-6 flex-grow flex flex-col justify-center">
                ...
                <!-- VIEW 0: LANDING WELCOME PAGE (Hapa ndipo mtumiaji anapoishia akifungua site kwanza) -->
