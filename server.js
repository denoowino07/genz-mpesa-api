...
// Main Route featuring Dashboard, Wallet, and Authentication
app.get('/', (req, res) => {
    res.send(`
        <!DOCTYPE html>
        <html lang="en">
        <head>
            ...
            <title>GenZTrending - FX & Wallet Dashboard</title>
        ...
        <body class="font-sans antialiased min-h-screen flex flex-col justify-between">
            ...
            <header class="border-b border-gray-800 bg-[#161b22] p-4">
                <div class="container mx-auto flex justify-between items-center">
                    ...
                    <div class="space-x-3">
                        <button onclick="switchView('login')" class="text-gray-300 hover:text-[#00ff66] font-medium text-sm transition">
                            Sign In
                        </button>
                        <button onclick="switchView('register')" class="bg-[#00ff66] text-black font-bold px-4 py-2 rounded text-sm hover:bg-[#00cc52] transition">
                            Create Account
                        </button>
                    </div>
                </div>
